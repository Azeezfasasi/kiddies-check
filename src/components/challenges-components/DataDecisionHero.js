...
export default function DataDecisionHero() {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="flex flex-col justify-center space-y-6 md:space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-700 leading-relaxed max-w-lg">
                Schools make critical decisions every day about safety, attendance, staffing, and parent engagement—but too often, those decisions rely on incomplete records, memory, or assumptions. Important patterns go unnoticed, risks build quietly, and opportunities to intervene early are missed.
              </p>
            </div>
          ...
          <div className="relative h-64 sm:h-80 md:h-96 lg:h-[500px] rounded-lg overflow-hidden shadow-xl">
            <Image
              ...
              alt="Data-informed decision making"
              fill
