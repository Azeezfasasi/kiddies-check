...
export default function PerformanceChart({ 
  ...
  const CustomTooltip = ({ active, payload }: { active?: boolean; payload?: Loose[] }) => {
  ...
  return (
    <div className="w-full bg-white rounded-xl border border-gray-300 shadow-lg p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Link href="/dashboard/student-assessments" className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-4 border border-blue-200">
        ...
        {/* Excellence Rate */}
        <Link href="/dashboard/student-assessments" className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg p-4 border border-green-200">
          <div className="flex items-center justify-between mb-3">
        ...
        {/* Total Students */}
        <Link href="/dashboard/all-students" className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-lg p-4 border border-purple-200">
