...
const AddEditModal = React.memo(({
  ...
  formData: Loose;
  setFormData: React.Dispatch<React.SetStateAction<Loose>>;
}) => {
...
const DeleteConfirmModal = React.memo(({ isOpen, onClose, onConfirm, schoolName }: { isOpen: boolean; onClose: () => void; onConfirm: () => void; schoolName?: string }) => {
  if (!isOpen) return null;
...
export default function SchoolManagement() {
  ...
  const [formData, setFormData] = useState<Loose>({
    name: "",
    email: "",
    phone: "",
    location: "",
