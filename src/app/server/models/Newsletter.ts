...
const campaignSchema = new mongoose.Schema({
  ...
  senderEmail: {
    type: String,
    default: process.env.NEWSLETTER_FROM_EMAIL || 'noreply@kiddiescheck.org',
  },
  senderName: {
    type: String,
    default: 'Kiddies Check',
  },
  recipients: {
    type: {
      type: String,
...
const Campaign = defineModel("Campaign", campaignSchema);
const Template = defineModel("Template", templateSchema);
const NewsletterActivityLog =
  defineModel("NewsletterActivityLog", activityLogSchema);
