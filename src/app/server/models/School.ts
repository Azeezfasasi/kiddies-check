...
/** Plain field shape of a School (as returned by `.lean()`). */
export type SchoolFields = InferSchemaType<typeof schoolSchema>;
/** A loaded School document (as returned by `findById` etc.). */
export type SchoolDocument = HydratedDocument<SchoolFields>;

export default defineModel("School", schoolSchema);
