...
export default function JuniorSecondaryReport() {
  return (
    <>
        {/* Laptop Report card */}
        <div className="hidden lg:block">
            <div>
                Junior secondary school Report Card is under development. Please check back later.
            </div>
        </div>
        ...
        <div className="block lg:hidden">
            <div className="mx-auto my-8 max-w-[850px] bg-white p-8 font-sans text-[13px] text-blue-900 border border-gray-300 shadow-lg print:my-0 print:p-4 print:shadow-none">
                <div className="text-center text-lg font-bold text-blue-900">
                    Junior Secondary Report card cannot be viewed on mobile.
                </div>
