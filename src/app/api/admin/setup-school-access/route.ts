...
export async function GET(request: NextRequest) {
  try {
    ...
    // Mongoose arrays cast the string id to an ObjectId.
    if (!user.managedSchools.includes(schoolId as unknown as Types.ObjectId)) {
      user.managedSchools.push(schoolId as unknown as Types.ObjectId);
      await user.save();
    }
