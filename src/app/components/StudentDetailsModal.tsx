                ...
                <div className="w-24 h-24 bg-blue-200 rounded-full flex items-center justify-center">
                  {studentData.picture ? (
                    <img
                      ...
                      onError={(e: React.SyntheticEvent<HTMLImageElement> & { target: HTMLImageElement }) => { e.target.style.display = 'none'; (e.target.parentNode as HTMLElement).innerHTML += `<span class='text-3xl'>👤</span>`; }}
                    />
                  ) : (
