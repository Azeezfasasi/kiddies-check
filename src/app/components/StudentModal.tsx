          ...
          <div>
            ...
            <div className="flex gap-3 items-start">
              ...
              <div className="w-20 h-20 bg-gray-100 rounded-lg border-2 border-dashed border-gray-300 flex items-center justify-center flex-shrink-0 overflow-hidden">
                {picturePreview ? (
                  <img src={picturePreview} alt="Preview" className="w-full h-full object-cover" crossOrigin="anonymous" onError={(e: React.SyntheticEvent<HTMLImageElement> & { target: HTMLImageElement }) => { e.target.src = ""; (e.target.parentNode as HTMLElement).innerHTML = `<div class='w-8 h-8 text-gray-400'></div>`; }} />
                ) : (
